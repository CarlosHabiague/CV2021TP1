###  TP6_Transformación de Similaridad con Eventos del mouse  ###
###                                                           ###
...
###            iniciando desde la esquina superior isquierda  ###
...
while (1):
    ...
    if k == (ord('e') or ord('E')): # Transforma y guarda la imágen nueva.
        ...
        angle = int(angle)
        scale = input('Ingrese un factor de estala (>1 para agrandar, <1 para achicar): ')
        scale = float(scale)
